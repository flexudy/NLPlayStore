from store.service.language_detection.fasttext.fasttext_language_detection_service import \
    Service as FasttextDetector
from store.service.language_detection.langdetect.langdetect_language_detection_service import \
    Service as Langdetect
from store.service.text_generation.cheapity3.cheapity3_text_generation_service import \
    Service as Cheapity3TextGenerator
